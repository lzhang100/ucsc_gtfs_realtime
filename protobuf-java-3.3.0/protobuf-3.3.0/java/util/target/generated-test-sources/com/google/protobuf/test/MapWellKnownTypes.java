...
public  final class MapWellKnownTypes extends
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    boolean result = true;
    result = result && internalGetAnyField().equals(
        other.internalGetAnyField());
    result = result && internalGetApiField().equals(
        other.internalGetApiField());
    result = result && internalGetDurationField().equals(
        other.internalGetDurationField());
    result = result && internalGetEmptyField().equals(
        other.internalGetEmptyField());
    result = result && internalGetFieldMaskField().equals(
        other.internalGetFieldMaskField());
    result = result && internalGetSourceContextField().equals(
        other.internalGetSourceContextField());
    result = result && internalGetStructField().equals(
        other.internalGetStructField());
    result = result && internalGetTimestampField().equals(
        other.internalGetTimestampField());
    result = result && internalGetTypeField().equals(
        other.internalGetTypeField());
    result = result && internalGetDoubleField().equals(
        other.internalGetDoubleField());
    result = result && internalGetFloatField().equals(
        other.internalGetFloatField());
    result = result && internalGetInt64Field().equals(
        other.internalGetInt64Field());
    result = result && internalGetUint64Field().equals(
        other.internalGetUint64Field());
    result = result && internalGetInt32Field().equals(
        other.internalGetInt32Field());
    result = result && internalGetUint32Field().equals(
        other.internalGetUint32Field());
    result = result && internalGetBoolField().equals(
        other.internalGetBoolField());
    result = result && internalGetStringField().equals(
        other.internalGetStringField());
    result = result && internalGetBytesField().equals(
